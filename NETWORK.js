var NETWORK = (function(){
	...
	function createRequestBody(_params, method) {
		...
		var client = Ti.Network.createHTTPClient({
			onload : function(e){
				onSuccess(this, _params.page, method, _params.data, _params.success);
				client = null;
			
			},
			onerror : function(e){
				//log.info(TAG, " code : " + e.code + "\n status : " + e.status + "\n data : " + e.data + "\n message : " + e.message + "\n Error : " + e.error);
				var json = this.responseText;
				
				log.info(TAG, "::::: Response :::::::\n" + JSON.stringify(json));
				onError(e, _params.page, method, _params.data, _params.fail);
				client = null;
			}, 
		...
		log.info(TAG, "URL :  "+ url + "\nHTTP PARAMS :" + JSON.stringify(_params.data) + "\n method : " + method);
